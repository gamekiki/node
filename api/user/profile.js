...
function execute(req, res, callback) {
  ...
  getUserProfile += '  a.userId as userId, userName as userName, userPoint, ';
  ...
  getUserProfile += '  ( SELECT ranking FROM leaderboard WHERE a.appId = appId AND a.userId = UserId ) as ranking, ';
